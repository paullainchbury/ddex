...
require "ddex/ern/v37D2/frame_rate"
...
require "ddex/ern/v37D2/video_codec_type"
...
class TechnicalVideoDetails < Element
  ...
  xml_name "TechnicalVideoDetails"
      ...
      xml_accessor :overall_bit_rate, :as => DDEX::ERN::V37D2::BitRate, :from => "OverallBitRate", :required => false
      xml_accessor :container_format, :as => DDEX::ERN::V37D2::ContainerFormat, :from => "ContainerFormat", :required => false
      xml_accessor :video_codec_type, :as => DDEX::ERN::V37D2::VideoCodecType, :from => "VideoCodecType", :required => false
      xml_accessor :video_bit_rate, :as => DDEX::ERN::V37D2::BitRate, :from => "VideoBitRate", :required => false
      xml_accessor :frame_rate, :as => DDEX::ERN::V37D2::FrameRate, :from => "FrameRate", :required => false
      ...
      xml_accessor :audio_bit_rate, :as => DDEX::ERN::V37D2::BitRate, :from => "AudioBitRate", :required => false
      xml_accessor :number_of_audio_channels, :as => Integer, :from => "NumberOfAudioChannels", :required => false
      xml_accessor :audio_sampling_rate, :as => DDEX::ERN::V37D2::SamplingRate, :from => "AudioSamplingRate", :required => false
