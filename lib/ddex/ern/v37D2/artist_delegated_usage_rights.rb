...
class ArtistDelegatedUsageRights < Element
  ...
  xml_name "ArtistDelegatedUsageRights"
      ...
      xml_accessor :period_of_rights_delegation, :as => DDEX::ERN::V37D2::Period, :from => "PeriodOfRightsDelegation", :required => true
      xml_accessor :territory_of_rights_delegations, :as => [DDEX::ERN::V37D2::CurrentTerritoryCode], :from => "TerritoryOfRightsDelegation", :required => true
