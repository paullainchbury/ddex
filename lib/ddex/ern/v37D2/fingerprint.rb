...
require "ddex/ern/v37D2/fingerprint_algorithm_type"
...
class Fingerprint < Element
  ...
  xml_name "Fingerprint"
      ...
      xml_accessor :fingerprint_algorithm_type, :as => DDEX::ERN::V37D2::FingerprintAlgorithmType, :from => "FingerprintAlgorithmType", :required => true
