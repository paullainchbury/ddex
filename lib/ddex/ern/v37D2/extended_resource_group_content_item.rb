...
require "ddex/ern/v37D2/linked_release_resource_reference"
require "ddex/ern/v37D2/release_id"
require "ddex/ern/v37D2/release_resource_reference"
require "ddex/ern/v37D2/resource_type"
...
class ExtendedResourceGroupContentItem < Element
  ...
  xml_name "ExtendedResourceGroupContentItem"
      ...
      xml_accessor :resource_types, :as => [DDEX::ERN::V37D2::ResourceType], :from => "ResourceType", :required => false
      xml_accessor :release_resource_reference, :as => DDEX::ERN::V37D2::ReleaseResourceReference, :from => "ReleaseResourceReference", :required => true
      xml_accessor :linked_release_resource_references, :as => [DDEX::ERN::V37D2::LinkedReleaseResourceReference], :from => "LinkedReleaseResourceReference", :required => false
