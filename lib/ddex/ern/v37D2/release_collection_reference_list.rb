...
require "ddex/ern/v37D2/release_collection_reference"
...
class ReleaseCollectionReferenceList < Element
  ...
  xml_name "ReleaseCollectionReferenceList"
      ...
      xml_accessor :release_collection_references, :as => [DDEX::ERN::V37D2::ReleaseCollectionReference], :from => "ReleaseCollectionReference", :required => true
